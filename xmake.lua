...
target("speedinjector")
set_kind("binary")
add_files("src/speedhackinjector.cpp")
add_files("src/injection.cpp")
add_files("src/process_utils.cpp")
add_files("src/tui_selection.cpp")
add_packages("ftxui")
add_defines("NOMINMAX")

target("audioapiinfo")
set_kind("shared")
add_files("src/audioapiinfo.cpp")
add_packages("microsoft-detours")
add_syslinks("dxguid", "ole32", "oleaut32", "mmdevapi", "user32", "uuid")
add_defines("NOMINMAX")

target("audioapiinjector")
set_kind("binary")
add_files("src/audioapiinjector.cpp")
add_files("src/injection.cpp")
add_files("src/process_utils.cpp")
add_files("src/tui_selection.cpp")
add_packages("ftxui")
